...
export const CONFIG = {
  ...
  THIRDWEB_CLIENT_ID: env(process.env.NEXT_THIRDWEB_CLIENT_ID),
  THIRDWEB_CLIENT_SECRET: env(process.env.NEXT_THIRDWEB_CLIENT_SECRET),
  NEXT_THIRDWEB_SERVER_ADMIN_SECRET: env(process.env.NEXT_THIRDWEB_SERVER_ADMIN_SECRET),
